...
public class CustomVIewPageAdapter extends PagerAdapter {
    ...
    Context context;
    int[] imageId = {R.drawable.welcome1, R.drawable.welcome2, R.drawable.welcome3, R.drawable.welcome4, R.drawable.welcome5};
    public ImageLoaderProfile imageLoader;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        setScaledImage(imageView, imageId[position]);
        //imageView.setImageResource(imageId[position]);

        //imageLoader=new ImageLoaderProfile(context);
        //imageLoader.DisplayImage("assets://artboard1.jpg",imageView);
